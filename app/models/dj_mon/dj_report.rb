module DjMon
  class DjReport
    ...
    class << self
      ...
      def all_reports
        reports_for DjMon::Backend.all.last(500)
      end

      def failed_reports
        reports_for DjMon::Backend.failed.last(500)
      end

      def active_reports
        reports_for DjMon::Backend.active.last(500)
      end

      def queued_reports
        reports_for DjMon::Backend.queued.last(500)
      end
